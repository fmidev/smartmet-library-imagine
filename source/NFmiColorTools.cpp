...
// 18.12.2001/Marko Moved all static varible instantiations here.
...
NFmiColorTools::NFmiBlendRule NFmiColorTools::Simplify(NFmiColorTools::NFmiBlendRule rule, int alpha)
{
