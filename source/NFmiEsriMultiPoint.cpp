...
namespace Imagine
{
  ...
  boost::shared_ptr<NFmiEsriElement> NFmiEsriMultiPoint::Clone() const
  {
	return boost::shared_ptr<NFmiEsriElement>(new NFmiEsriMultiPoint(*this));
  }
