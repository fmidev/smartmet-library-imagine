...
#ifdef _MSC_VER
#pragma warning( disable : 4996 ) // VC++ k‰‰nt‰j‰ll‰ tulee paljon varoitusta 'turvattomien'  funktioiden k‰ytˆst‰, t‰ss‰ fopen pit‰isi muka korvata fopen_s -funktiolla.
#endif
...
namespace Imagine
{
  ...
  // Laiton viel‰ blenderin parametriksi, koska min‰ olen havainnut ongelmia MSVC-k‰‰nt‰j‰n kanssa, kun
