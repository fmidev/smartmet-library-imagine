	...
	while(i < theText.size())
	  {
		...
		if(use_kerning && previous!=0 && glyph_index!=0)
		  {
			FT_Vector delta;
			FT_Get_Kerning(theFace,previous,glyph_index,
						  ...
						  NFmiColorTools::NFmiBlendRule theBackgroundRule) const
  {
	...
	switch(rule)
	  ...
	  case NFmiColorTools::kFmiColorClear:
		itsPimple->Draw(NFmiColorBlendClear(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorCopy:
		itsPimple->Draw(NFmiColorBlendCopy(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorAddContrast:
		itsPimple->Draw(NFmiColorBlendAddContrast(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorReduceContrast:
		itsPimple->Draw(NFmiColorBlendReduceConstrast(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorOver:
		itsPimple->Draw(NFmiColorBlendOver(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorUnder:
		itsPimple->Draw(NFmiColorBlendUnder(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorIn:
		itsPimple->Draw(NFmiColorBlendIn(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorKeepIn:
		itsPimple->Draw(NFmiColorBlendKeepIn(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorOut:
		itsPimple->Draw(NFmiColorBlendOut(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorKeepOut:
		itsPimple->Draw(NFmiColorBlendKeepOut(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorAtop:
		itsPimple->Draw(NFmiColorBlendAtop(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorKeepAtop:
		itsPimple->Draw(NFmiColorBlendKeepAtop(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorXor:
		itsPimple->Draw(NFmiColorBlendXor(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorPlus:
		itsPimple->Draw(NFmiColorBlendPlus(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorMinus:
		itsPimple->Draw(NFmiColorBlendMinus(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorAdd:
		itsPimple->Draw(NFmiColorBlendAdd(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorSubstract:
		itsPimple->Draw(NFmiColorBlendSubstract(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorMultiply:
		itsPimple->Draw(NFmiColorBlendMultiply(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorDifference:
		itsPimple->Draw(NFmiColorBlendDifference(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorCopyRed:
		itsPimple->Draw(NFmiColorBlendCopyRed(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorCopyGreen:
		itsPimple->Draw(NFmiColorBlendCopyGreen(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorCopyBlue:
		itsPimple->Draw(NFmiColorBlendCopyBlue(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorCopyMatte:
		itsPimple->Draw(NFmiColorBlendCopyMatte(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorCopyHue:
		itsPimple->Draw(NFmiColorBlendCopyHue(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorCopyLightness:
		itsPimple->Draw(NFmiColorBlendCopyLightness(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorCopySaturation:
		itsPimple->Draw(NFmiColorBlendCopySaturation(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorKeepMatte:
		itsPimple->Draw(NFmiColorBlendKeepMatte(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorKeepHue:
		itsPimple->Draw(NFmiColorBlendKeepHue(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorKeepLightness:
		itsPimple->Draw(NFmiColorBlendKeepLightness(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorKeepSaturation:
		itsPimple->Draw(NFmiColorBlendKeepSaturation(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorBumpmap:
		itsPimple->Draw(NFmiColorBlendBumpmap(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorDentmap:
		itsPimple->Draw(NFmiColorBlendDentmap(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorOnOpaque:
		itsPimple->Draw(NFmiColorBlendOnOpaque(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
	  case NFmiColorTools::kFmiColorOnTransparent:
		itsPimple->Draw(NFmiColorBlendOnTransparent(), face, theImage, theX, theY, theText, theAlignment, theColor, theBackgroundOn, theBackgroundWidth, theBackgroundHeight, theBackgroundColor, theBackgroundRule);
		break;
