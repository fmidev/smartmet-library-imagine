...
void latlon2merc(double lat, double lon, double clat, double* y, double* x)
{
  ...
  *y=nort;
  ...
  void NFmiImage::WriteICE(FILE *out, const string & theFileName) const
  {
    ...
    /*
    Resoluution keskellä saa muuntamalla kulmien arvot
    mercator-projektion northing ja easting arvoihin ja sitten
    pystyresoluution metreissä saa jakamalla northingien erotuksen pikselien
    määrällä pystysuunnassa (rows) ja vaakaresoluution vastaavasti jakamalla
    eastingien erotuksen pikselien määrällä tässä suunnassa (cols).
    */
