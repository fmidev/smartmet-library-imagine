...
#define EXPECT(a,b) if(a.SVG() != b) TEST_FAILED("Expected '"+string(b)+"', got '"+a.SVG()+"'");
  ...
  void Fit()
  {
...

	{
	  ...
	  EXPECT(s,"M230.878,135.041 C220.229,141.832 216.719,162.98 206.452,166.624 204.85,167.192 205.844,163.279 205.617,161.595 203.094,142.849 223.33,102.126 230.406,133.195");
	}
...

	{
	  ...
	  s = NFmiTightBezierFit::Fit(p,5);
	  EXPECT(s,"M85.382,327.957 C84.455,320.386 65.295,325.94 70.19,335.162 76.155,346.399 86.64,338.231 85.382,327.957");
	}
	...
	// A self touching curve:
	{
	  ...
	  EXPECT(s,"M-100,0 C-100,-1.03 -95.731,-4.269 -94.922,-5.078 -90.104,-9.896 -85.286,-14.714 -80.469,-19.531 -72.917,-27.083 -65.365,-34.635 -57.812,-42.188 -56.567,-43.433 -51.585,-50 -50,-50 -49.787,-50 -41.189,-41.189 -40.234,-40.234 -30.339,-30.339 -20.443,-20.443 -10.547,-10.547 -9.516,-9.516 -0.23,0 0,0 0.213,0 8.811,-8.811 9.766,-9.766 19.661,-19.661 29.557,-29.557 39.453,-39.453 40.484,-40.484 49.77,-50 50,-50 51.585,-50 56.567,-43.433 57.812,-42.188 65.365,-34.635 72.917,-27.083 80.469,-19.531 85.286,-14.714 90.104,-9.896 94.922,-5.078 95.731,-4.269 100,-1.03 100,0 100,1.03 95.731,4.269 94.922,5.078 90.104,9.896 85.286,14.714 80.469,19.531 72.917,27.083 65.365,34.635 57.812,42.188 56.567,43.433 51.585,50 50,50 49.787,50 41.189,41.189 40.234,40.234 30.339,30.339 20.443,20.443 10.547,10.547 9.516,9.516 0.23,0 0,0 -0.213,0 -8.811,8.811 -9.766,9.766 -19.661,19.661 -29.557,29.557 -39.453,39.453 -40.484,40.484 -49.77,50 -50,50 -51.585,50 -56.567,43.433 -57.812,42.188 -65.365,34.635 -72.917,27.083 -80.469,19.531 -85.286,14.714 -90.104,9.896 -94.922,5.078 -95.731,4.269 -100,1.03 -100,0");
	...
	// A difficult case for NFmiApproximateBezierFit:
	{
	  ...
	  EXPECT(s,"M60.2,95.8 C60.168,95.849 54.961,92.813 54.482,92.54 48.031,88.862 41.58,85.184 35.129,81.505 27.212,76.991 19.295,72.477 11.377,67.963 10.642,67.544 3.827,64.178 3.9,63.7 3.928,63.521 16.634,56.487 20.362,54.388 22.767,53.034 38.453,43.3 39.8,43.5 41.309,43.725 44.617,48.519 45.737,49.688 53.179,57.443 54.292,72.82 56.964,83.213 57.263,84.374 60.209,95.786 60.2,95.8");
	}
...
int main(void)
{
  using namespace std;
  cout << endl
	   << "NFmiTightBezierFit tester" << endl
	   << "=========================" << endl;
