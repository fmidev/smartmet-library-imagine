...
#ifndef IMAGINE_NFMIESRIPOLYGONM_H
#define IMAGINE_NFMIESRIPOLYGONM_H
...
namespace Imagine
{
  ...
  public:
	...
	NFmiEsriPolygonM(int theNumber=0,
					 NFmiEsriElementType theType=kFmiEsriPolygonM)
	...
	NFmiEsriPolygonM(const std::string & theBuffer,
					 int thePos=0,
					 int theNumber=0);
...
#endif // IMAGINE_NFMIESRIPOLYGONM_H
