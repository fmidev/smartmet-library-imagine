...
namespace Imagine
{
  ...
  inline
  int NFmiColorTools::GetAlpha(Color c)
  {
	return (c>>24)&0x7F;
  }
  ...
  inline
  int NFmiColorTools::GetRed(Color c)
  {
	return (c>>16)&0xFF;
  }
  ...
  inline
  int NFmiColorTools::GetGreen(Color c)
  {
	return (c>>8)&0xFF;
  }
  ...
  inline
  int NFmiColorTools::GetBlue(Color c)
  {
	return (c&0xFF);
  }
  ...
  inline
  NFmiColorTools::Color NFmiColorTools::GetRGB(Color c)
  {
	return (c&0xFFFFFF);
  }
  ...
  inline
  NFmiColorTools::Color NFmiColorTools::ReplaceAlpha(Color c, int alpha)
  {
  ...
  inline
  NFmiColorTools::Color NFmiColorTools::ReplaceRed(Color c, int red)
  {
  ...
  inline
  NFmiColorTools::Color NFmiColorTools::ReplaceGreen(Color c, int green)
  {
  ...
  inline
  NFmiColorTools::Color NFmiColorTools::ReplaceBlue(Color c, int blue)
  {
  ...
  inline
  NFmiColorTools::Color NFmiColorTools::MakeColor
  ...
  inline
  NFmiColorTools::Color NFmiColorTools::SafeColor(int r, int g, int b, int a)
  {
  ...
  inline
  NFmiColorTools::Color NFmiColorTools::SafestColor(int r, int g, int b, int a)
  {
	return
	  (
	   (((a<0) ? 0 : (a>NFmiColorTools::MaxAlpha)? NFmiColorTools::MaxAlpha: a)<< 24) +
  ...
  inline
  NFmiColorTools::Color NFmiColorTools::AddContrast(Color theColor)
  {
  ...
  inline
  NFmiColorTools::Color NFmiColorTools::ReduceContrast(Color theColor)
  {
	return Contrast(theColor,-1);
  }
  ...
  inline
  NFmiColorTools::Color NFmiColorTools::Simplify(Color c, int opaquethreshold, bool ignorealpha)
  {
	if(ignorealpha)
